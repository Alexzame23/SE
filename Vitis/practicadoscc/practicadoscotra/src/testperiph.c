...
int main () 
{
	u32 data_read;
	while(1){
		COPRO_mWriteReg(XPAR_COPRO_0_COPRO_S00_AXI_BASEADDR,
		...
		data_read= COPRO_mReadReg(XPAR_COPRO_0_COPRO_S00_AXI_BASEADDR,
		...
		data_read=
				COPRO_mReadReg(XPAR_COPRO_0_COPRO_S00_AXI_BASEADDR,
