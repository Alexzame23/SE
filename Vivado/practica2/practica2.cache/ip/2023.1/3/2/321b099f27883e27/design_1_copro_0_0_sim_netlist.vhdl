...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_divisor1Hz is
  ...
  signal \cuenta[16]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of clk_aux_i_6 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \cuenta[16]_i_4\ : label is "soft_lutpair5";
  attribute ADDER_THRESHOLD : integer;
...
\cuenta[16]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\cuenta[16]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFB"
    )
        port map (
