...
namespace eval ::optrace {
  variable script "F:/SE/Vivado/proyecto/proyecto.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet F:/SE/Vivado/proyecto/proyecto.runs/synth_1/design_1_wrapper.dcp
