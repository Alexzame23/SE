...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: copro_0, and set properties
	set copro_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:copro:1.0 copro_0 ]
	...
	# Connect all clock & reset of copro_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins copro_0/COPRO_S00_AXI]
	connect_bd_net [get_bd_pins copro_0/copro_s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins copro_0/copro_s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to copro_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/copro_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_copro_0_COPRO_S00_AXI_* ]]
	puts $fp "set copro_s00_axi_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:copro:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/copro_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "copro_v1_0_hw_${i}"
