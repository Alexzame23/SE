...
#define INFRARROJOS_S00_AXI_SLV_REG0_OFFSET 0
#define INFRARROJOS_S00_AXI_SLV_REG1_OFFSET 4
#define INFRARROJOS_S00_AXI_SLV_REG2_OFFSET 8
#define INFRARROJOS_S00_AXI_SLV_REG3_OFFSET 12
 ...
 *
 * @param   BaseAddress is the base address of the INFRARROJOSdevice.
 ...
 * @note
 * C-style signature:
 * 	void INFRARROJOS_mWriteReg(u32 BaseAddress, unsigned RegOffset, u32 Data)
 *
 */
 ...
 * @note
 * C-style signature:
 * 	u32 INFRARROJOS_mReadReg(u32 BaseAddress, unsigned RegOffset)
 *
 */
 ...
 *
 */
XStatus INFRARROJOS_Reg_SelfTest(void * baseaddr_p);
